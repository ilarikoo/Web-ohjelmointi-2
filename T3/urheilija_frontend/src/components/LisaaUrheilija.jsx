...
//Komponentti urheilijan lisäämiseen
export default function LisaaUrheilija() {
  let history = useNavigate();
  // urheilijan ominaisuudet ovat stateja, joita päivitetään lomakkeella
  ...
  const submitClickEvent = async (event) => {
    ...
    try {
      ...
      // Lisätään urheilija
      urheilijatContext.addUrheilija(uusiUrheilija);
      history("/");
    } catch (e) {
